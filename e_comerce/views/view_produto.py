...
def produto(request,categoria_slug,produto_slug):
    sigle_product=get_object_or_404(Produto.objects.select_related('category').prefetch_related('category'),slug=produto_slug,category__slug=categoria_slug,disponivel=True)
